...
class Deck
{
	...
	{
		//Over loaded deck method so a user can request the number of decks to use.
		init(numPacks);
	}
	...
	public void init(int numPacks)
	{
		...
		//Initializes the pointer and cards array based on the requested number of packs.
		topCard = numPacks * 52;
		cards = new Card[topCard];
		//Calls allocateMasterPack to make sure the master pack has been created.
		allocateMasterPack();
		//Uses arraycopy to copy the number of requested packs from masterPack into cards.
